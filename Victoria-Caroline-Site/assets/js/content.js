...
(() => {
  ...
  const contentModule = {
    ...
    buildDishCard(item) {
      ...
      // Preço é opcional: tratamentos estéticos/odontológicos são
      // avaliados caso a caso, não têm preço fixo por item.
      const hasPrice = typeof item.preco === "number";
