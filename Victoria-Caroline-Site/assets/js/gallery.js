...
(() => {
  ...
  const GALLERY_FALLBACK = [
    { src: "assets/images/galeria/01-ambiente.jpg", alt: "Ambiente do consultório da Dra. Victoria Caroline" },
    { src: "assets/images/galeria/02-ambiente.jpg", alt: "Consultório acolhedor e instagramável" },
    { src: "assets/images/galeria/03.jpg", alt: "Detalhe do consultório" },
    { src: "assets/images/galeria/04.jpg", alt: "Ambiente da clínica" },
    { src: "assets/images/galeria/05.jpg", alt: "Estrutura do consultório" },
    { src: "assets/images/galeria/06.jpg", alt: "Resultado de facetas em resina" },
    { src: "assets/images/galeria/07.jpg", alt: "Harmonização facial" },
    { src: "assets/images/galeria/08.jpg", alt: "Paciente atendido pela Dra. Victoria Caroline" },
  ];
